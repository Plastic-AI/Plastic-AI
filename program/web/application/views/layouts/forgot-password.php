...
<head>
	...
	<title>PlasticAI - Forgot Password</title>
...
<body>
	<div id="particles">
		<div id="webcoderskull" class="single-layout d-flex align-items-center justify-content-center ht-100v">
			...
			<?php echo form_open(base_url('forgot_password'), array('id' => 'forgot_password', 'class' => 'login-wrapper wd-300 wd-xs-400 pd-25 pd-xs-40 bg-white rounded shadow-base animated bounceIn')); ?>
			...
			<br>
			<p style="text-align: center;">Input your email to recover your account.</p>

			<?php $this->load->view('layouts/message');?>

			<div class="form-group">
				<input class="form-control" type="email" name="email" value="<?php print set_value('email');?>" placeholder="Email">
			...
			<button class="btn btn-primary btn-block" type="submit">Forgot Password <i class="ion ion-md-log-in"></i></button>

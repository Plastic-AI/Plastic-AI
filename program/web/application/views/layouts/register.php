...
<body>
	...
	<div id="particles">
		<div id="webcoderskull" class="single-layout d-flex align-items-center justify-content-center ht-100v">
			...
			<?php echo form_open(base_url('register'), array('id' => 'register', 'enctype' => 'multipart/form-data', 'class' => 'register-wrapper wd-300 wd-xs-400 pd-25 pd-xs-40 bg-white rounded shadow-base animated bounceIn')); ?>
			...
			<br>
			<p style="text-align: center;">Easy steps to join us.</p>

			<?php $this->load->view('layouts/message');?>

			<div class="form-group">
                <input class="form-control" type="text" name="name" value="<?php print set_value('name');?>" autocomplete="off" placeholder="Fullname">
                <ul class="field-message parsley-errors-list filled">
                    <?php if(isset($_POST['name'])) echo form_error('name', '<li class="tx-danger-100">', '</li>'); ?>
                </ul>
            </div>

			<div class="form-group">
				<input class="form-control" type="text" name="login" value="<?php print set_value('login');?>" autocomplete="off" placeholder="Username">
				<ul class="field-message parsley-errors-list filled">
			...
			<div class="form-group">
				<input class="form-control" type="text" name="email" value="<?php print set_value('email');?>" autocomplete="off" placeholder="Email">
				<ul class="field-message parsley-errors-list filled">
					<?php if(isset($_POST['email'])) echo form_error('email', '<li class="tx-danger-100">', '</li>'); ?>
				</ul>
			</div>
            ...
            <div class="form-group">
                <input class="form-control" type="password" name="confirm_passwd" value="<?php print set_value('confirm_passwd');?>" placeholder="Confirm Password" autocomplete>
                <ul class="field-message parsley-errors-list filled">
                    <?php if(isset($_POST['confirm_passwd'])) echo form_error('confirm_passwd', '<li class="tx-danger-100">', '</li>'); ?>
                </ul>
            </div>
			...
			<div class="mg-y-15">
				<div class="input-group">
					<input class="form-control" type="text" name="captcha" autocomplete="off" placeholder="Captcha Code">
			...
			<button class="btn btn-primary btn-block" type="submit">Sign Up <i class="ion ion-md-log-in"></i></button>

			<div class="mg-t-20 tx-center">Already have an account? <a href="<?php print base_url('login');?>" class="tx-primary">Sign In</a></div>

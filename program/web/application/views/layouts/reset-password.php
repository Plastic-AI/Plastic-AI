...
<head>
	...
	<title>PlasticAI - Reset Password</title>
	<link href="<?php print base_url('assets/img/icon.png');?>" rel="shortcut icon">
...
<body>
	<div id="particles">
		<div id="webcoderskull" class="single-layout d-flex align-items-center justify-content-center ht-100v">
			...
			<?php echo form_open(base_url('reset_password'), array('id' => 'reset_password', 'class' => 'login-wrapper wd-300 wd-xs-400 pd-25 pd-xs-40 bg-white rounded shadow-base animated bounceIn')); ?>
			...
			<br>
			<p style="text-align: center;">Create new password for your account.</p>

			<?php $this->load->view('layouts/message');?>

			<div class="form-group">
				<input class="form-control" type="password" name="password" value="<?php print set_value('password');?>" placeholder="New Password">
				<ul class="field-message parsley-errors-list filled">
					<?php if(isset($_POST['password'])) echo form_error('password', '<li class="tx-danger-100">', '</li>'); ?>
				</ul>
			</div>
			
			<div class="form-group">
				<input class="form-control" type="password" name="confirm_password" value="<?php print set_value('confirm_password');?>" placeholder="Confirm New Password">
				<ul class="field-message parsley-errors-list filled">
					<?php if(isset($_POST['confirm_password'])) echo form_error('confirm_password', '<li class="tx-danger-100">', '</li>'); ?>
				</ul>
			</div>
			...
			<div class="mg-t-20 tx-center">Remember your account password? <a href="<?php print base_url('login');?>" class="tx-primary">Sign In</a></div>

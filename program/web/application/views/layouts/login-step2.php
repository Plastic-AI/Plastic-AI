...
<body>
	<div id="particles">
		<div id="webcoderskull" class="single-layout d-flex align-items-center justify-content-center ht-100v">
			...
			<?php echo form_open(NULL, array('class' => 'login-wrapper wd-300 wd-xs-400 pd-25 pd-xs-40 bg-white rounded shadow-base animated bounceIn')); ?>
			...
			<br>
			<p style="text-align: center;">Please Input One Time Password</p>

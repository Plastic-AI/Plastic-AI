...
<body class="pos-relative">
	...
	<div class="ht-100v d-flex align-items-center justify-content-center">
		<div class="wd-lg-70p wd-xl-50p tx-center pd-x-40">
			<h1 class="tx-100 tx-xs-140 tx-normal tx-inverse tx-roboto mg-b-0">Oops!</h1><br />
			<h5 class="tx-xs-24 tx-normal tx-info mg-b-30 lh-5">Looks like there was a problem.</h5>
			<p class="tx-16 mg-b-30"><?php echo str_replace(array("<p class=\"tx-16 mg-b-30\">", "</p>"), "", $heading).". ".str_replace(array("<p>", "</p>"), "", $message); ?></p>

# USAGE
# py -3.6 predict.py --image <image_path> --model model/plastic.model --label-bin model/plastic_lb.pickle --width 32 --height 32 --flatten 1
...
save_place 		= 'files/images/detected/' + predict_token + '/'
